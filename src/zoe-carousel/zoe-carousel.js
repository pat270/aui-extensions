YUI().add(
  ...
  function(A) {
    var Lang = A.Lang,
        ...
        TPL_ITEM = '<li><a class="' + CSS_MENU_ITEM + ' {cssClasses}" href="">{index}</a></li>',

        TPL_MENU = '<menu>' +
          '<li><a class="' + CSS_MENU_ITEM + ' ' + CSS_MENU_PLAY + '" href=""></a></li>' +
          '<li><a class="' + CSS_MENU_ITEM + ' ' + CSS_MENU_PREV + '" href=""></a></li>' +
          '{items}' +
          '<li><a class="' + CSS_MENU_ITEM + ' ' + CSS_MENU_NEXT + '" href=""></a></li>' +
          '</menu>',
